...
class EmbeddedJettyIT {
    ...
    void setUp() throws Exception {
        log.info("Unit test injected property: {}", this.configuration.getProperty());
    }
    ...
    private static void startJettyServer() throws Exception {
        ...
        // Enable Weld + CDI
        // context.setInitParameter(CdiServletContainerInitializer.CDI_INTEGRATION_ATTRIBUTE, CdiSpiDecorator.MODE);
        // context.addServletContainerInitializer(new CdiServletContainerInitializer());
        // context.addServletContainerInitializer(new org.jboss.weld.environment.servlet.EnhancedListener());

        // wrap the system classloader in a simple URLClassLoader suitable for use by the JSP implementation
        context.setClassLoader(new URLClassLoader(new URL[0], EmbeddedJettyIT.class.getClassLoader()));
